...
const VolunteerRegister = () => {
    ...
    return (
        <div className='h-screen flex flex-col gap-10'>
            <nav className='flex md:text-2xl text-lg justify-between relative font-bold bg-[#0D9488] p-4 items-center'>
                ...
                <button onClick={handleClick} className='cursor-pointer rounded-2xl md:px-5 md:py-3 px-1 py-0.5 active:scale-95 bg-white text-[#0D9488] '>Admin DashBoard</button>
            </nav>
            {flag && (
