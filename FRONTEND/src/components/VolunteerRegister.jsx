...
const VolunteerRegister = () => {
    ...
    return (
        <div className='h-screen flex flex-col gap-10'>
            <nav className='flex text-2xl justify-between relative font-bold bg-[#0D9488] p-4 items-center'>
                <img src={Logo} alt="Logo" className='w-16 h-16 ' />
                <h1 className='text-white font-extrabold text-4xl tracking-widest uppercase ml-36'>Naye Pankh Foundation</h1>
                <button onClick={handleClick} className='cursor-pointer rounded-2xl px-5 py-3 active:scale-95 bg-white text-[#0D9488] '>Admin DashBoard</button>
            </nav>
            {flag && (
